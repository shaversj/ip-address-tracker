...
export default function Header({ fetcher }: HeaderProps) {
  ...
  return (
    <header className={"flex h-[300px] flex-col items-center md:h-[280px]"}>
      ...
      <fetcher.Form id={"ipForm"} method="post" className={"z-40 flex flex-col px-6 pt-[29px] md:px-0 lg:pt-[31px]"}>
        <div className={"flex"}>
          <input
            type={"text"}
            name={"ipAddress"}
